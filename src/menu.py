...
class Menu():
    ...
    def high_score_screen(self):
        while True:
            ...
            self.hs_back = Button(image=None, pos=(100, 700), text_input="Menu", font=self.get_font(45),
                                  base_color="Blue", hovering_color="Red")
    ...
    def play(self):
        while True:
            ...
            self.screen.fill("black")
            self.menu_back = Button(image=None, pos=(100, 720), text_input="Menu", font=self.get_font(30),
                                    base_color="Blue", hovering_color="Red")
    ...
    def main_menu(self):
        ...
        while True:
            ...
            self.play_button = Button(None, pos=(600, 680), text_input="PLAY", font=self.get_font(20),
                                      base_color="Yellow", hovering_color="Blue")
            self.high_score_button = Button(None, pos=(600, 715), text_input="HIGH SCORE", font=self.get_font(20),
                                            base_color="Yellow", hovering_color="Pink")
            self.quit_button = Button(None, pos=(600, 750), text_input="QUIT", font=self.get_font(20),
                                      base_color="Yellow", hovering_color="Red")
